...
c Capacity scales for CHP units /small, medium, large/
...
co17, co18, co19, co20, co21, co22, co23, co24, co25, co26, co27, co28, co29, co30,
co31, co32, co33, co34, co35_1, co35_2, co36, co37, co38, co39, co40, co41, co42,
co43_1, co43_2, co44_1, co44_2, co45_1, co45_2, co46, co47, co48, co49, co50, co51,
co52, co53, co54, co55, co56, co57, co58, co59, co60, test_pipe,
co_TEST1, co_TEST2, co_TEST3
;
...
*                                                    + Sum((e,p,s,t),beta_PowP(p)*(e_PBg_conv*lambda_nrg(e)*Y_PBg_conv(p,t)+e_Fuel(s)*mu_Fuel(s,e)*Y_Fuel_conv(s,p,t)))
                                                    ...
                                                    + Sum((b,e,t),e_LC_nrg(b)*E_Bref(e,b,t));
*                                                    + Sum((e,p,t),ep_LC_nrg(p)*E_PowP(e,p,t));
...
eps_co1        ..  Net_GHG_emission_savings - Surplus2 =e= epsilon2;
...
co17(i,j,t)          .. Sum((b,l,k),XT_Bm(j,i,b,l,k,t)*(1-varsigma_Bm(j,i))) =l= ucap_Bm(j,i,t)*z_src(i,j);

co18(b,i,j,lg,t,k)   .. XT_Bm(j,i,b,lg,k,t) =l= lc_Bm(lg,j)*FL_Bm(lg,j,i,b,t);

* co19 wbd(i,b) = binary parameter

co20(lp,b,jp,i,k)    .. Sum(t,XT_Bm(jp,i,b,lp,k,t)) =l= Z_src_Bref(i,jp,b,lp)*bigM;

co21(jnp,i,b,lp,k,t) .. XT_Bm(jnp,i,b,lp,k,t) =e= 0;

co22(jp,i,b,lp,t) .. Sum((k),XT_Bm(jp,i,b,lp,k,t)) =g= cap_Bm(jp,t)*minflow*Z_src_Bref(i,jp,b,lp);

co23(b,k,j)          .. Sum((i,l,t),XT_Bm(j,i,b,l,k,t)) =l= Sum((h,c),Z_Bref(b,k,h,c)*tcb(k,j)*bigM);

co24(b,j,n,t,k)      .. X_prdct(n,j,b,k,t) =e= Sum((i,l),theta_prdct(j,k,n)*XT_Bm(j,i,b,l,k,t));

co25(b,t,h)          .. X_PBg(b,h,t) =e= phi_PBg(h)*Y_Bg_conv(b,h,t);

co26(b,n,t)          .. Sum((j,k),X_prdct("Raw_Bg",j,b,k,t)) =e= Sum(h,Y_Bg_conv(b,h,t))+Sum(c,Y_Bg(b,c,t))+Sum((m,lg),TS_prdct("Raw_Bg",b,m,lg,t));

co27(b,n,t)          .. Sum(h,Y_Bg_conv(b,h,t))-Sum(c,Y_Bg(b,c,t)) =e= Sum((m,lg),TS_prdct("Raw_Bg",b,m,lg,t));

co28(b,np,t)         .. Sum((m,lg),TS_prdct(np,b,m,lg,t)) =e= Sum((j,k),X_prdct(np,j,b,k,t));

co29(b,m,lg,n,t)     .. TS_prdct(n,b,m,lg,t) =l= lc_prdct(lg,n)*FL_prdct(lg,n,b,m,t);

*** co30 only for 3 layers --> second one. for 4 layers --> first one
*co30(b,t)           .. Sum(h,X_PBg(b,h,t)) =e= Sum((lg,p),T_trans_PBg(b,p,lg,t)) + Sum((lg,m),TS_PBg(b,m,lg,t));
co30(b,t)            .. Sum(h,X_PBg(b,h,t)) =e= Sum((lg,m),TS_PBg(b,m,lg,t));

*co31(b,lg,p,t)      .. T_trans_PBg(b,p,lg,t) =l= lc_PBg(lg)*FL_PBg(lg,b,p,t);

co32(b,m,lg,t)       .. TS_PBg(b,m,lg,t) =l= lc_PBg(lg)*FLp_PBg(lg,b,m,t);

co33(b,e,t)          .. X_nrg(e,b,t) =e= Sum((j,i,l,k),kappa_Bm(e,j,k)*XT_Bm(j,i,b,l,k,t))+Sum(h,kappa_PBg(e,h)*Y_Bg_conv(b,h,t))+Sum(c,kappa_Bg(c,e)*Y_Bg(b,c,t));

co34(b,e,t)          .. X_nrg(e,b,t) =e= R_Bref(e,b,t)+S_nrg(e,b,t);

co35_1(b,e,t)        .. S_nrg(e,b,t) =l= q_max_nrg(e,b,t);
co35_2(b,e,t)        .. S_nrg(e,b,t) =g= q_min_nrg(e,b,t);

co36(b,e,t)          .. Sum((j,i,l,k),er_Bm(e,j,k)*XT_Bm(j,i,b,l,k,t))+Sum(h,er_Bg(e,h)*Y_Bg_conv(b,h,t))+Sum(c,er_Bg_CHP(e,c)*Y_Bg(b,c,t)) =e= R_Bref(e,b,t)+E_Bref(e,b,t);

*co37(p,t)           .. Y_PBg_conv(p,t)+Y_PBg_CHP(p,t) =e= Sum((b,lg),T_trans_PBg(b,p,lg,t));

*co38(p,s,t)         .. Y_Fuel_conv(s,p,t)+Y_Fuel_CHP(s,p,t) =e= Sum(lg,V_Fuel(s,p,lg,t));

*co39(lg,p,s,t)      .. V_Fuel(s,p,lg,t) =l= lc_Fuel(lg,s)*FL_Fuel(lg,s,p,t);

*co40(e,p,t)         .. Xp_nrg(e,p,t) =e= lambda_nrg(e)*Y_PBg_conv(p,t)+Sum((s),mu_Fuel(s,e)*Y_Fuel_conv(s,p,t))+lambdap_nrg(e)*Y_PBg_CHP(p,t)+Sum((s),mup_Fuel(s,e)*Y_Fuel_CHP(s,p,t));

*co41(e,p,t)         .. Xp_nrg(e,p,t) =e= R_PowP(e,p,t)+Sum((w),Sp_nrg(e,p,w,t));

*co42(e,p,t)         .. er_PBg(e,p)*Y_PBg_conv(p,t)+Sum((s),er_Fuel(e,s,p)*Y_Fuel_conv(s,p,t))+er_PBg_CHP(e,p)*Y_PBg_CHP(p,t)+Sum((s),er_Fuel_CHP(e,s,p)*Y_Fuel_CHP(s,p,t)) =e= R_PowP(e,p,t)+E_PowP(e,p,t);

co43_1(m,n,t)        .. Sum((b,lg),TS_prdct(n,b,m,lg,t)) =l= q_max_prdct(n,m,t);
co43_2(m,n,t)        .. Sum((b,lg),TS_prdct(n,b,m,lg,t)) =g= q_min_prdct(n,m,t);

co44_1(m,t)          .. Sum((b,lg),TS_PBg(b,m,lg,t)) =l= q_max_PBg(m,t);
co44_2(m,t)          .. Sum((b,lg),TS_PBg(b,m,lg,t)) =g= q_min_PBg(m,t);

*co45_1(e,t,w)       .. Sum((p),Sp_nrg(e,p,w,t)) =l= qp_max_nrg(e,w,t);
*co45_2(e,t,w)       .. Sum((p),Sp_nrg(e,p,w,t)) =g= qp_min_nrg(e,w,t);

co46(b,j,t)           ..   Sum((i,k,l),XT_Bm(j,i,b,l,k,t)) =l= cap_Bm(j,t);


co47(b,n,k,t)          .. Sum((j),X_prdct(n,j,b,k,t)) =l= Sum((h,c),cap_tech_prod(k,n)*Z_Bref(b,k,h,c));
*co48(b,n,k,t)          .. Sum((j),X_prdct(n,j,b,k,t)) =g= Sum((h,c),cap_tech_prod(k,n)*Z_Bref(b,k,h,c)*delta_tech(k,n));

co49(b,h,t)            .. X_PBg(b,h,t) =l= Sum((c,k),1.158*cap_tech_PBg(h)*Z_Bref(b,k,h,c));
*co50(b,h,t)            .. X_PBg(b,h,t) =g= Sum((c,k),1.158*cap_tech_PBg(h)*Z_Bref(b,k,h,c)*deltap_tech(h));


co51(b,e,t)            .. X_nrg(e,b,t) =l= Sum((k,h,c),cap_CHP(c,e)*Z_Bref(b,k,h,c));
*co52(b,e,t)            .. X_nrg(e,b,t) =g= Sum((k,h,c),cap_CHP(c,e)*Z_Bref(b,k,h,c)*delta_CHP(c,e));


*co53(e,p,t)           .. Xp_nrg(e,p,t) =l= (cap_PowP(p,e)+capp_CHP(p,e));
*co54(e,p,t)           .. Xp_nrg(e,p,t) =g= (cap_PowP(p,e)*delta_PowP(p)+capp_CHP(p,e)*deltap_CHP(p,e));

* co55 A = (pi * D^2)/4 --> Q = V * A ==> cap_pipe

co56(jp,i,b,lp,t)  .. Sum((k),XT_Bm(jp,i,b,lp,k,t)) =l= cap_pipe;

co57(b)              .. Sum((k,h,c),Z_Bref(b,k,h,c)) =l= 1;

co58(b,i)              .. Sum((jp,lp),Z_src_Bref(i,jp,b,lp)) =l= Sum((k,h,c),Z_Bref(b,k,h,c));


co59(i,jp,b,lp)      .. Z_src_Bref(i,jp,b,lp) =l= wbd(i,b)*z_src(i,jp);
...
co17, co18, co20, co21, co22,
co23, co24, co25, co26, co27, co28, co29, co30,
*co31,
co32, co33, co34, co35_1, co35_2, co36,
*co37, co38, co39, co40, co41, co42,
co43_1, co43_2, co44_1, co44_2,
*co45_1, co45_2,
...
*Solve BSC using MIP max Net_GHG_emission_savings;
*Solve BSC using MIP max Social_Benefit;

Display
loopCount2, loopCount3,
NPV.l, Net_GHG_emission_savings.l, Social_Benefit.l,
...
*execute_unload "results1.gdx" XT_Bm
*execute 'gdxxrw.exe results1.gdx o=results1.xlsx var=XT_Bm'

*execute_unload "results2.gdx" TS_prdct
*execute 'gdxxrw.exe results2.gdx o=results2.xlsx var=TS_prdct'

*execute_unload "results3.gdx" TS_PBg
*execute 'gdxxrw.exe results3.gdx o=results3.xlsx var=TS_PBg'
